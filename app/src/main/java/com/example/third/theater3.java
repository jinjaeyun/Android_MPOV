...
public class theater3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(get2.getStringExtra("theater").equals("theater3")) {
            getSupportActionBar().setTitle("3관");
        }
        else if(get2.getStringExtra("theater").equals("theater6")){
            getSupportActionBar().setTitle("6관");
        }
        DBHelper dbHelper = new DBHelper(theater3.this, 2);
        ...
        for(int i =0; i<14; i++) {
            if (i==0) {
                for (int j = 1; j <= 8; j++) {
                    ...
                    r_param.addRule(RelativeLayout.ALIGN_LEFT, 8 * i + j - 1);
                    ...
                    seat[i][j].setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            AlertDialog.Builder ad = new AlertDialog.Builder(theater3.this);
                            ...
                            scope_button.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    AlertDialog.Builder ad2 = new AlertDialog.Builder(theater3.this);
                            ...
                            move_button.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    if(et2.length()==0){
                                        ...
                                        Intent intent1 = new Intent(theater3.this, unityPlugin.class);
                                        Intent get1 = getIntent();
                                        intent1.putExtra("theater", "theater3");
                ...
                for(int j=1; j<=8; j++){
                    if(j==1){
                        ...
                        r_param.addRule(RelativeLayout.BELOW, 8 * i + j - 8);
                                ...
                                scope_button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        scope_button2.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View view) {
                                                if(dbHelper.getResult(get2.getStringExtra("theater"),(char)(65+ finalI1) + String.valueOf(finalJ1)).length()==0) {
                                                    dbHelper.insert(get2.getStringExtra("theater"), (char) (65 + finalI1) + String.valueOf(finalJ1), Float.parseFloat(score.getText().toString()));
                                                    dialog2.dismiss();
                                                    value.setText(dbHelper.getResult(get2.getStringExtra("theater"), (char) (65 + finalI1) + String.valueOf(finalJ1)));
                                                }
                                                else{
                                                    dbHelper.Update(get2.getStringExtra("theater"), (char) (65 + finalI1) + String.valueOf(finalJ1),Float.parseFloat(score.getText().toString()));
                                                    dialog2.dismiss();
                                                    value.setText(dbHelper.getResult(get2.getStringExtra("theater"), (char) (65 + finalI1) + String.valueOf(finalJ1)));
                                                }
                                            }
                                ...
                                move_button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if(et2.length()==0){
                                            ...
                                            Intent get1 = getIntent();
                                            intent1.putExtra("theater", "theater3");
                                            intent1.putExtra("seat",(char)(65+ finalI1) + String.valueOf(finalJ1) + et2.getText().toString());
                                            startActivity(intent1);
                                        }
                                        else{
                                            Toast.makeText(getApplicationContext(),"키 범위를 벗어났습니다.",Toast.LENGTH_LONG).show();
                ...
                for(int j=1; j<2; j++) {
                    ...
                    RelativeLayout.LayoutParams r_param = new RelativeLayout.LayoutParams(130, 130);
                    seat[i][j].setId(8 * i + j);
                    seat[i][j].setText((char)(65+i-3) + String.valueOf(j+8));
                    r_param.addRule(RelativeLayout.BELOW, 8 * (i-3) + j - 8);
                    r_param.addRule(RelativeLayout.ALIGN_LEFT, 8 * (i-3) + j - 1);
                            ...
                            scope_button.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    scope_button2.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            if (dbHelper.getResult(get2.getStringExtra("theater"),(char)(65+ finalI1 -3) + String.valueOf(finalJ1+8)).length() ==0 ) {
                                                dbHelper.insert(get2.getStringExtra("theater"), (char) (65 + finalI1 - 3) + String.valueOf(finalJ1 + 8), Float.parseFloat(score.getText().toString()));
                                                dialog2.dismiss();
                                                value.setText(dbHelper.getResult(get2.getStringExtra("theater"), (char) (65 + finalI1 - 3) + String.valueOf(finalJ1 + 8)));
                                            }
                                            else{
                                                dbHelper.Update(get2.getStringExtra("theater"),(char) (65 + finalI1 - 3) + String.valueOf(finalJ1 + 8),Float.parseFloat(score.getText().toString()));
                                                dialog2.dismiss();
                                                value.setText(dbHelper.getResult(get2.getStringExtra("theater"), (char) (65 + finalI1 - 3) + String.valueOf(finalJ1 + 8)));
                                            }
                                        }
                            ...
                            move_button.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    if(et2.length()==0){
                                        ...
                                        Intent get1 = getIntent();
                                        intent1.putExtra("theater", "theater3");
                                        intent1.putExtra("seat",(char)(65+ finalI1 -3) + String.valueOf(finalJ1+8) + et2.getText().toString());
                                        startActivity(intent1);
                                    }
                                    else{
                                        Toast.makeText(getApplicationContext(),"키 범위를 벗어났습니다.",Toast.LENGTH_LONG).show();
                    ...
                    public void onClick(View view) {
                        if(et2.length()==0){
                            ...
                            if(et.length()==0){
                                ...
                                if (sea.equals("A") || sea.equals("B") || sea.equals("C") || sea.equals("D") || sea.equals("E") || sea.equals("F")
                                        || sea.equals("G") || sea.equals("H")) {
                                    if(ihei.matches("[+-]?\\d*(\\.\\d+)?")) {
                                        if(Integer.parseInt(ihei)>=1 && Integer.parseInt(ihei)<=8) {
                                            Intent intent1 = new Intent(theater3.this, unityPlugin.class);
                                            Intent get1 = getIntent();
                                            intent1.putExtra("theater", "theater3");
                                ...
                                else if(sea.equals("I") || sea.equals("K")){
                                    if(ihei.matches("[+-]?\\d*(\\.\\d+)?")) {
                                        if(Integer.parseInt(ihei)>=1 && Integer.parseInt(ihei)<=9) {
                                            Intent intent1 = new Intent(theater3.this, unityPlugin.class);
                                            Intent get1 = getIntent();
                                            intent1.putExtra("theater", "theater3");
                                            intent1.putExtra("seat", et.getText().toString() + et2.getText().toString());
                                ...
                                else if(sea.equals("J")){
                                    if(ihei.matches("[+-]?\\d*(\\.\\d+)?")) {
                                        if(Integer.parseInt(ihei)>=2 && Integer.parseInt(ihei)<=9) {
                                            Intent intent1 = new Intent(theater3.this, unityPlugin.class);
                                            Intent get1 = getIntent();
                                            intent1.putExtra("theater", "theater3");
                                            intent1.putExtra("seat", et.getText().toString() + et2.getText().toString());
