...
public class theater1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_theater1);
        scrollView = findViewById(R.id.scrollView);
        scrollView.setHorizontalScrollBarEnabled(true);
        scrollView.setBackgroundColor(Color.parseColor("#333333"));

        Intent get2 = getIntent();
        if(get2.getStringExtra("theater").equals("theater1")){
            getSupportActionBar().setTitle("1관");
        }
        else if(get2.getStringExtra("theater").equals("theater4")){
            getSupportActionBar().setTitle("4관");
        }
        else if(get2.getStringExtra("theater").equals("theater7")){
            getSupportActionBar().setTitle("7관");
        }


        DBHelper dbHelper = new DBHelper(theater1.this, 2);

        RelativeLayout relative1 = new RelativeLayout(this);
        Button[][] seat = new Button[255][255];
        ...
        //열(A1~A14, J1~J14, I15~I16, J15~J16)
        for(int i =0; i<12; i++) {
            if (i==0) {
                for (int j = 1; j <= 14; j++) {
                    if(j==11){
                        ...
                        seat[i][j].setId(14 * i + j);
                        r_param.addRule(RelativeLayout.ALIGN_LEFT, 14*i+j - 1);
                        ...
                        seat[i][j].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                AlertDialog.Builder ad = new AlertDialog.Builder(theater1.this);
                                ...
                                scope_button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        AlertDialog.Builder ad2 = new AlertDialog.Builder(theater1.this);
                                ...
                                move_button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if(et2.length()==0){
                                            ...
                                            Intent intent1 = new Intent(theater1.this, unityPlugin.class);
                ...
                for(int j=1; j<3; j++) {
                    if (j == 1) {
                        ...
                        RelativeLayout.LayoutParams r_param = new RelativeLayout.LayoutParams(130, 130);
                        seat[i][j].setId(14 * i + j);
                        seat[i][j].setText((char)(65+i-2) + String.valueOf(j+14));
                        r_param.addRule(RelativeLayout.BELOW, 14 * (i-2) + j - 14);
                        r_param.addRule(RelativeLayout.ALIGN_LEFT, 14 * (i-2) + j - 1);
                                ...
                                scope_button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        scope_button2.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View view) {
                                                if(dbHelper.getResult(get2.getStringExtra("theater"),(char)(65+ finalI1 -2) + String.valueOf(finalJ1+14)).length()==0) {
                                                    dbHelper.insert(get2.getStringExtra("theater"), (char)(65+ finalI1 -2) + String.valueOf(finalJ1+14), Float.parseFloat(score.getText().toString()));
                                                    dialog2.dismiss();
                                                    value.setText(dbHelper.getResult(get2.getStringExtra("theater"), (char)(65+ finalI1 -2) + String.valueOf(finalJ1+14)));
                                                }
                                                else{
                                                    dbHelper.Update(get2.getStringExtra("theater"), (char)(65+ finalI1 -2) + String.valueOf(finalJ1+14),Float.parseFloat(score.getText().toString()));
                                                    dialog2.dismiss();
                                                    value.setText(dbHelper.getResult(get2.getStringExtra("theater"), (char)(65+ finalI1 -2) + String.valueOf(finalJ1+14)));
                                                }
                                            }
                                ...
                                move_button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if(et2.length()==0){
                                            ...
                                            Intent get1 = getIntent();
                                            intent1.putExtra("theater", "theater1");
                                            intent1.putExtra("seat",(char)(65+ finalI1 -2) + String.valueOf(finalJ1+14) + et2.getText().toString());
                                            startActivity(intent1);
                                        }
                                        else{
                                            Toast.makeText(getApplicationContext(),"키 범위를 벗어났습니다.",Toast.LENGTH_LONG).show();
                                ...
                                scope_button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        scope_button2.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View view) {
                                                if (dbHelper.getResult(get2.getStringExtra("theater"), (char)(65+ finalI2 -2) + String.valueOf(finalJ2+14)).length() == 0)
                                                {
                                                    dbHelper.insert(get2.getStringExtra("theater"), (char)(65+ finalI2 -2) + String.valueOf(finalJ2+14), Float.parseFloat(score.getText().toString()));
                                                    dialog2.dismiss();
                                                    value.setText(dbHelper.getResult(get2.getStringExtra("theater"), (char)(65+ finalI2 -2) + String.valueOf(finalJ2+14)));
                                                }
                                                else{
                                                    dbHelper.Update(get2.getStringExtra("theater"),(char)(65+ finalI2 -2) + String.valueOf(finalJ2+14),Float.parseFloat(score.getText().toString()));
                                                    dialog2.dismiss();
                                                    value.setText(dbHelper.getResult(get2.getStringExtra("theater"), (char)(65+ finalI2 -2) + String.valueOf(finalJ2+14)));
                                                }
                                            }
                                ...
                                move_button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if(et2.length()==0){
                                            ...
                                            Intent get1 = getIntent();
                                            intent1.putExtra("theater", "theater1");
                                            intent1.putExtra("seat",(char)(65+ finalI2 -2) + String.valueOf(finalJ2+14) + et2.getText().toString());
                                            startActivity(intent1);
                                        }
                                        else{
                                            Toast.makeText(getApplicationContext(),"범위를 벗어난 수입니다.",Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                                ad.setCancelable(false);
                ...
                for (int j = 1; j <= 14; j++) {
                    ...
                    if(j==1){
                        r_param.addRule(RelativeLayout.BELOW, 14*i+j - 14);
                        r_param.addRule(RelativeLayout.ALIGN_LEFT, 14*i+j - 15*i);
                    }
                    else{
                        r_param.addRule(RelativeLayout.BELOW, 14*i+j - 14);
                        r_param.addRule(RelativeLayout.ALIGN_LEFT, 14*i+j - 1);
                    ...
                    public void onClick(View view) {
                        if (et2.length() == 0) {
                            ...
                            if (et.length() == 0) {
                                ...
                                if (sea.equals("B") || sea.equals("C") || sea.equals("D") || sea.equals("E") || sea.equals("F")
                                ...
                                } else if (sea.equals("I") || sea.equals("J")) {
                                    if (ihei.matches("[+-]?\\d*(\\.\\d+)?")) {
                                        if (Integer.parseInt(ihei) >= 1 && Integer.parseInt(ihei) <= 16) {
                                            Intent intent1 = new Intent(theater1.this, unityPlugin.class);
                                            Intent get1 = getIntent();
                                            intent1.putExtra("theater", "theater1");
                                            intent1.putExtra("seat", et.getText().toString() + et2.getText().toString());
                                    ...
                                    if (ihei.matches("[+-]?\\d*(\\.\\d+)?")) {
                                        if (Integer.parseInt(ihei) >= 1 && Integer.parseInt(ihei) <= 14 && Integer.parseInt(ihei) != 11) {
                                            Intent intent1 = new Intent(theater1.this, unityPlugin.class);
                                            Intent get1 = getIntent();
                                            intent1.putExtra("theater", "theater1");
                                            intent1.putExtra("seat", et.getText().toString() + et2.getText().toString());
